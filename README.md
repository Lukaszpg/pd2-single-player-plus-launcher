...
7. **IMPORTANT!** Click settings in the launcher in the top left corner and check the `Play with PlugY` checkbox. Adjust the path where do you want your single player and stash to be stored.
...
5. Adjust the path where do you want your single player and stash to be stored.
